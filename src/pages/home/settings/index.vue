            ...
            <div class="sessionSettings">
                ...
                <div style="display: flex; flex-direction: column;">
                    <div>
                        ...
                        <span>上午</span>
                        <ElInputNumber class="classNumInput" v-model="globalStore.selectedSession.juniorAMCount"
                                       :min="0"
                                       :max="4"/>
                        <span style="margin-left: 10px;">下午</span>
                        <ElInputNumber class="classNumInput" v-model="globalStore.selectedSession.juniorPMCount"
                                       :min="0"
                                       :max="4"/>
                    </div>
                    <div style="margin-top: 10px;">
                        ...
                        <span>上午</span>
                        <ElInputNumber class="classNumInput" v-model="globalStore.selectedSession.middleAMCount"
                                       :min="0"
                                       :max="4"/>
                        <span style="margin-left: 10px;">下午</span>
                        <ElInputNumber class="classNumInput" v-model="globalStore.selectedSession.middlePMCount"
                                       :min="0"
                                       :max="4"/>
                    </div>
                </div>
